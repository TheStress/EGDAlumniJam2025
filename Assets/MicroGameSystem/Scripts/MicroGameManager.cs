...
public abstract class MicroGameManager : MonoBehaviour {
    ...
    [SerializeField] InputInstructionType instructionType = InputInstructionType.BOTH; // The image that will flash on screen before the micro game
    ...
    public InputInstructionType GetInstructionType() { return instructionType; }
